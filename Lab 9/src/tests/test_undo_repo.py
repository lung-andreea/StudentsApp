...
class TestUndoRepo(unittest.TestCase):
    ...
    def testSave(self):
        ...
        self.assertEqual(self.__undoRepo.save(studCtrl,discCtrl,grdCtrl), (studCtrl,discCtrl,grdCtrl), 'Function save doesn\'t work!')
    ...
    def testUndo(self):
        ...
        self.assertEqual(self.__undoRepo.undo(), (self.__studCtrl,self.__discCtrl,self.__grdCtrl), 'Function undo doesn\'t work!')
    ...
    def testRedo(self):
        ...
        self.assertEqual(self.__undoRepo.redo(), (studCtrl,discCtrl,grdCtrl), 'Function redo doesn\'t work!')
        self.assertRaises(UndoRepositoryException)